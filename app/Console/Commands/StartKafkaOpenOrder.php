...
class StartKafkaOpenOrder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'StartKafkaOpenOrder:session';
     ...
     * @var string
     */
    protected $description = 'This will start a Kafka open order request debugging tool';
    ...
    public function message($message)
    {
        try {
            ...
            $redisExpiration    = env('REDIS_TOOL_OPEN_REQUEST_EXPIRE', 300);
    ...
    public function handle()
    {
        ...
        $queue = $rk->newQueue();
        $topic = $rk->newTopic(env('KAFKA_SCRAPE_OPEN_ORDERS'), $topicConf);
