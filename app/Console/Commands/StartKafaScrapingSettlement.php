...
class StartKafaScrapingSettlement extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'StartKafaScrapingSettlement:session';
     ...
     * @var string
     */
    protected $description = 'This will start a Kafka scraping settlement debugging tool';
