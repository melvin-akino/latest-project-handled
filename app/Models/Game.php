...
class Game extends Model
{
    ...
    public static function getGameDetails(int $masterLeagueId, string $schedule = 'early', int $userId, array $provMaintenance = [])
    {
        ...
        if (!empty($provMaintenance)) {
            $query = $query->whereNotIn('p.alias', $provMaintenance);
        }
