...
class KafkaConsume implements CustomProcessInterface
{
    ...
    public static function callback(Server $swoole, Process $process)
    {
        ...
        sleep(5);
        TransformKafkaMessage::dispatch((object) ['payload' => self::testData2()]);
