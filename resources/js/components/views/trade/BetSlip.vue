<template>
    <div class="betslip flex justify-center items-center">
        <dialog-drag v-for="market_id in openedBetSlips" :key="market_id" :title="'Bet Slip - '+market_id" :options="options" @close="closeBetSlip(market_id)">
