        ...
        <div class="mx-auto sm:bg-white sm:shadow-lg md:w-160 sm:w-120 xs:w-100 w-full h-auto sm:px-12 px-4 pt-12 pb-4 mt-6">
            ...
            <form method="POST" @submit.prevent="sendEmailToResetPassword">
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none text-sm" :class="{'border-red-600': $v.email.$error}" id="email" type="text" placeholder="Receive password reset link using your email." v-model="$v.email.$model" @keyup="clearEmailMessage">
