<div id="billing-address" class="tab-pane fade">
    <div class="row">
        <div class="col-md-4">
            <form name="form-edit-billing-address" id="form-edit-billing-address"
                  action="{{ route('accounts.billing_addresses.update', [$account, $account->billing_address()->first()->billing_address_id]) }}#billing-address"
                  method="POST">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="form-group{{ $errors->has('ba_first_name') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="first-name-input" name="ba_first_name"
                           placeholder="First Name" value="{{ old('ba_first_name', $account->billing_address()->first()->first_name) }}">
                ...
                <div class="form-group{{ $errors->has('ba_last_name') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="last-name-input" name="ba_last_name"
                           placeholder="Last Name" value="{{ old('ba_last_name', $account->billing_address()->first()->last_name) }}">
                ...
                <div class="form-group{{ $errors->has('ba_city') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="city-input" name="ba_city"
                           placeholder="City" value="{{ old('ba_city', $account->billing_address()->first()->city) }}">
                ...
                <div class="form-group{{ $errors->has('ba_billing_address') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="billing-address-input" name="ba_billing_address"
                           placeholder="Billing Address" value="{{ old('ba_billing_address', $account->billing_address()->first()->billing_address) }}">
                ...
                <div class="form-group{{ $errors->has('ba_billing_address_second') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="billing-address-second-input"
                           ...
                           placeholder="Billing Address 2" value="{{ old('ba_billing_address_second', $account->billing_address()->first()->billing_address_second) }}">
                ...
                <div class="form-group{{ $errors->has('ba_postalcode') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"
                           ...
                           value="{{ old('ba_postalcode', $account->billing_address()->first()->postalcode) }}">
                ...
                <div class="form-group{{ $errors->has('ba_phone') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"
                           ...
                           value="{{ old('ba_phone', $account->billing_address()->first()->phone) }}">
                ...
                @usercan('edit', 'accounts.billing_addresses.update')
...
@section('script')
    ...
    <script>
        $(function () {
            $('#form-edit-billing-address').find('#country-select').select2({
                placeholder: "Select a country",
                data: countries
            }).val("{{ old('ba_country', $account->billing_address()->first()->country) }}").trigger('change');

            $('#form-edit-billing-address').submit(function () {
